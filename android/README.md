...
```gradle
dependencies {
    implementation 'com.github.apiverve:languagedetector-api:1.1.12'
}
```
...
```java
import com.apiverve.languagedetector.LanguageDetectorAPIClient;
import com.apiverve.languagedetector.APIResponse;
import com.apiverve.languagedetector.APIException;

// Initialize the client
LanguageDetectorAPIClient client = new LanguageDetectorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/languagedetector](https://docs.apiverve.com/ref/languagedetector)
...
- **Documentation:** [https://docs.apiverve.com/ref/languagedetector](https://docs.apiverve.com/ref/languagedetector)
- **Issues:** [GitHub Issues](https://github.com/apiverve/languagedetector-api/issues)
